...
const { createJob, getJobs, getJobById, updateJob, getFilters, getDashboardMetrics, viewJob, modifyJob, duplicateJob, deactivateJob, cancelJob, getJobsByDate, applyForJob, getUserJobs, getOngoingJobs, getCompletedJobs, getCancelledJobs, searchJobs, getAppliedJobs, getTotalCancelledJobs } = require('../controllers/jobController');
...
router.get('/cancelled-job', getCancelledJobs);
